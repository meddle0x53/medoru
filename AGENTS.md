...
- Service worker cache bumped to `medoru-v204`; game bundle bumped to `game.js?v=304`.
- **Bake-neko defend sprite**: Replaced `enemy_bake_neko_defend.png` with the newly supplied asset, added a brief defend-pose flash on non-lethal hits, and stopped status icons from reappearing above defeated enemies.
