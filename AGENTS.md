...
- **Planned: weapon/shield socket charm system**: Design captured in `.agents/logs/PLAN-weapon-sockets-and-builds.md`. Weapons/shields will have 4 sockets unlocked at +1, +3, +6, +7. First-socket charms (Sharp, Heavy, Elemental gems, Lucky, etc.) override scaling and unlock ability families. Future sockets will add passive procs, hybrid scaling, and ultimates. Abilities will gain charm/cooldown/once-per-battle requirements.
