      ...
      this.tweens.add({
        ...
        onComplete: () => {
          ...
          this.pendingRewards = openChest(this.player)
          {
            ...
            let essenceAmount = 0
            if (roll < 0.10) {
              essenceAmount = this.player.addOuroEssence(this.player.applyNgPlusMultiplier(2))
            } else if (roll < 0.30) {
              essenceAmount = this.player.addOuroEssence(this.player.applyNgPlusMultiplier(4))
            }
            if (essenceAmount > 0) {
