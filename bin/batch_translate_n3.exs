...
# N3 Words Batch Translation Script
# Translates 135,847 N3 words in batches of 50 using pipe-separated format
# Usage: mix run bin/batch_translate_n3.exs
...
defmodule BatchTranslator do
  ...
  # Paths
  @progress_file "data/export/words_n3_progress.json"
  @output_file "data/export/words_n3_bg.json"
  @input_file "data/export/words_n3.json"
  ...
  def run do
    ...
    IO.puts("🌙 N3 Words Batch Translator")
    IO.puts("============================")
