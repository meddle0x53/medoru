...
#
#     PHX_SERVER=true bin/medoru start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :medoru, MedoruWeb.Endpoint, server: true
end

# Configure Ueberauth Google OAuth credentials
...
if config_env() == :prod do
  ...
  config :medoru, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
