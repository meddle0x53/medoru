  ...
  def apply do
    fix_kanji("可",
      strokes: [
        %{
          path:
            "M13.88,21.98C18,22.75,21.74,22.34,25.39,22c13.57-1.26,43.04-4.34,58.11-5.52c3.93-0.31,7.74-0.5,11.63,0.33",
          order: 1,
          type: "horizontal",
        ...
        %{
          path: "M31.2,61.83c5.62-0.7,11.39-1.52,17.83-2.29c1.21-0.14,2.43-0.29,3.69-0.43",
          order: 4,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path:
            "M75.46,20.33c1.04,1.04,2.01,2.67,2.01,4.77c0,14.56-0.01,60.44-0.01,65.4c0,10.62-7.96,1.25-9.46,0",
          order: 5,
          type: "hook",
          direction: "top-to-bottom"
        }
    ...
    fix_kanji("籠",
      strokes: [
        %{
          path: "M31.99,9.75c0.04,0.46,0.1,1.2-0.09,1.87c-1.12,3.94-7.57,12.59-16.4,17.88",
          order: 1,
          type: "diagonal",
          direction: "top-left-to-bottom-right"
        },
        %{
          path: "M28.73,20.29C32.72,20.29,45.52,17,50,17",
          order: 2,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path: "M36.02,21.83C38.83,23.45,43.3,28.48,44,31",
          order: 3,
          type: "dot",
          direction: "top-left-to-bottom-right"
        },
        %{
          path: "M64.97,9.25c0.04,0.42,0.17,1.09-0.08,1.68C63.06,15.32,57.98,21.6,51.25,27",
          order: 4,
          type: "diagonal",
          direction: "top-left-to-bottom-right"
        },
        %{
          path: "M61.98,17.68c4.58,0,21.37-3.2,26.52-3.2",
          order: 5,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path: "M81.48,17.5c0.03,0.21,0.07,0.55-0.06,0.85c-0.78,1.8-5.27,5.74-11.42,8.15",
          order: 6,
          type: "diagonal",
          direction: "top-right-to-bottom-left"
        },
        %{
          path: "M32.38,27.75c0.16,0.47,0.4,1.53,0.4,2.73c0,1.66,0,2.61,0,5.23",
          order: 7,
          type: "vertical",
          direction: "top-to-bottom"
        },
        ...
        %{
          path: "M21.91,40.64c3.54,4.16,5.15,8.41,5.47,11.15",
          order: 9,
          type: "dot",
          direction: "top-left-to-bottom-right"
        },
        %{
          path: "M44.29,37.74c0.55,0.38,0.61,1.43,0.55,1.75c-0.44,2.16-4.99,8.61-6.08,10.27",
          order: 10,
          type: "diagonal",
          direction: "top-right-to-bottom-left"
        },
        ...
        %{
          path: "M23.07,61c0.3,0.52,0.5,1.04,0.6,1.55c0.1,0.52,0.14,34.28,0.1,35.45",
          order: 12,
          type: "vertical",
          direction: "top-to-bottom"
        },
        ...
        %{
          path: "M24.02,71.64c6.05-0.38,15.92-0.74,21.23-0.93",
          order: 14,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path: "M24.78,82.15c4.38-0.43,13.98-1.34,19.05-1.85",
          order: 15,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path: "M66.35,34.06c4.37-0.32,13.31-1.52,18.25-2.11c1.12-0.13,1.83,0.09,2.4,0.18",
          order: 16,
          type: "horizontal",
          direction: "left-to-right"
        },
        ...
        %{
          path: "M64,54.25c4.78-0.32,14.83-1.5,21.5-1.79",
          order: 18,
          type: "horizontal",
          direction: "left-to-right"
        },
        ...
        %{
          path: "M64.75,62.88c4.71-0.29,15.35-1.11,20.68-1.65c1.21-0.12,1.97,0.08,2.59,0.17",
          order: 20,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path: "M64.91,73.43c4.34-0.38,15.53-1.08,20.45-1.77c1.12-0.16,1.82,0.1,2.39,0.21",
          order: 21,
          type: "horizontal",
          direction: "left-to-right"
        },
        %{
          path: "M64.49,84.25c4.33-0.17,16.84-0.64,21.74-0.95c1.12-0.07,1.81,0.05,2.38,0.09",
          order: 22,
          type: "horizontal",
          direction: "left-to-right"
        }
