defmodule Medoru.Games.KanjiFallingSession do
  @moduledoc """
  Schema for kanji falling game sessions.
  ...
  schema "kanji_falling_sessions" do
  ...
  @doc false
  def changeset(kanji_falling_session, attrs) do
    kanji_falling_session
    |> cast(attrs, [
      :status,
      :score,
