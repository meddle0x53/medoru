defmodule Medoru.Games.WordsFallingSession do
  @moduledoc """
  Schema for words falling game sessions.
  ...
  schema "words_falling_sessions" do
  ...
  @doc false
  def changeset(words_falling_session, attrs) do
    words_falling_session
    |> cast(attrs, [
      :status,
      :score,
