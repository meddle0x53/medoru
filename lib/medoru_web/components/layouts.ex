      ...
      <div class="flex-none">
        <ul class="flex items-center space-x-1 sm:space-x-2">
          <%= if @current_scope && @current_scope.current_user do %>
            ...
            <li class="dropdown dropdown-end ml-2 pl-2 sm:ml-4 sm:pl-4 border-l border-base-300">
              ...
              >
                ...
                <li>
                  <.link
                    navigate={~p"/settings/chat-shortcuts?#{locale_qs(@current_scope[:locale])}"}
                    class="flex items-center gap-2"
                  >
          ...
          <% else %>
            ...
            <%!-- Language Selector for Anonymous Users --%>
            <li class="dropdown dropdown-end hidden sm:block">
              <div
                tabindex="0"
                role="button"
            ...
            <%!-- Mobile Menu Toggle for Anonymous Users --%>
            <li class="md:hidden">
              <button
                type="button"
                class="btn btn-ghost btn-sm btn-circle touch-target"
                phx-click={JS.toggle(to: "#mobile-nav-drawer-anon")}
                aria-label={gettext("Menu")}
              >
                <.icon name="hero-bars-3" class="w-6 h-6" />
              </button>
            ...
            <%!-- Mobile Navigation Drawer for Anonymous Users --%>
            <div
              id="mobile-nav-drawer-anon"
              class="fixed inset-0 z-50 hidden"
              ...
              <nav class="absolute left-0 top-0 bottom-0 w-72 max-w-[85vw] bg-base-100 shadow-2xl flex flex-col overflow-y-auto">
                ...
                <div class="flex-1 py-2">
                  ...
                  <.link
                    ...
                    class="flex items-center gap-3 px-4 py-3 text-sm font-medium hover:bg-base-200 transition-colors"
                  >
            ...
            <%!-- Sign in Button (Mobile - when menu is hidden) --%>
            <li class="md:hidden">
              <.link
                href={~p"/auth/google"}
                class="btn btn-ghost btn-sm btn-circle touch-target"
