  ...
  def mount(%{"classroom_id" => classroom_id, "game_id" => game_id} = params, _session, socket) do
    ...
    cond do
      ...
      true ->
        ...
        high_score =
          if is_anonymous, do: nil, else: Games.get_kanji_falling_high_score(game.id, user.id)

        sessions = if is_anonymous, do: [], else: Games.list_kanji_falling_sessions(game.id)
