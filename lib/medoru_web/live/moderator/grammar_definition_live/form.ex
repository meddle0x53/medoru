defmodule MedoruWeb.Moderator.GrammarDefinitionLive.Form do
  @moduledoc """
  Moderator form for creating and editing grammar definitions.
    ...
    case Content.update_grammar_definition(socket.assigns.grammar_definition, attrs) do
      {:ok, _grammar_definition} ->
        {:noreply,
         ...
         |> push_navigate(to: ~p"/moderator/grammars")}
