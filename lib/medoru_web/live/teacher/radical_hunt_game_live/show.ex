defmodule MedoruWeb.Teacher.RadicalHuntGameLive.Show do
  @moduledoc """
  LiveView for teachers to view a radical hunt game's details and rankings.
  """
  ...
  def mount(%{"classroom_id" => classroom_id, "id" => id}, _session, socket) do
    ...
    if classroom.teacher_id != user.id or game.classroom_id != classroom_id do
      ...
      sessions = Games.list_radical_hunt_sessions(game.id)
  ...
  defp game_skill_label(1), do: gettext("Beginner")
  defp game_skill_label(2), do: gettext("Elementary")
  defp game_skill_label(3), do: gettext("Intermediate")
  defp game_skill_label(4), do: gettext("Advanced")
  defp game_skill_label(5), do: gettext("Expert")
  defp game_skill_label(_), do: gettext("Unknown")
end
