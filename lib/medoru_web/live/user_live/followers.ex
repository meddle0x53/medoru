defmodule MedoruWeb.UserLive.Followers do
  @moduledoc """
  LiveView for displaying a user's followers list.
  ...
  def handle_params(%{"id" => user_id}, _url, socket) do
    ...
    if current_user && current_user.id == user.id do
      page = 1
      followers = Social.list_followers(user_id, page: page, per_page: @per_page)
      total_count = Social.count_followers(user_id)
      ...
      {:noreply,
       socket
       |> put_flash(:error, gettext("You can only view your own followers."))
