defmodule Medoru.Repo.Migrations.CreateKanaFallingSessions do
  use Ecto.Migration

  def change do
    create table(:kana_falling_sessions, primary_key: false) do
    ...
    create index(:kana_falling_sessions, [:game_id])
    create index(:kana_falling_sessions, [:user_id])
    create index(:kana_falling_sessions, [:game_id, :user_id])
    create index(:kana_falling_sessions, [:game_id, :score])
  end
end
