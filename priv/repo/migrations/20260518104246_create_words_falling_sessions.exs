defmodule Medoru.Repo.Migrations.CreateWordsFallingSessions do
  use Ecto.Migration

  def change do
    create table(:words_falling_sessions, primary_key: false) do
    ...
    create index(:words_falling_sessions, [:game_id])
    create index(:words_falling_sessions, [:user_id])
    create index(:words_falling_sessions, [:game_id, :user_id])
    create index(:words_falling_sessions, [:game_id, :score])
  end
end
