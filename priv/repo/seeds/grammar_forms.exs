...
verb_forms = [
  ...
  %{name: "potential", display_name: "可能形 (られる)", word_type: "verb", suffix_pattern: "られる", description: "Potential form (can do)"},
  %{name: "passive", display_name: "受身形 (られる)", word_type: "verb", suffix_pattern: "られる", description: "Passive form"},
  %{name: "causative", display_name: "使役形 (させる)", word_type: "verb", suffix_pattern: "させる", description: "Causative form (make/let do)"},
  %{name: "imperative", display_name: "命令形 (ろ)", word_type: "verb", suffix_pattern: "ろ", description: "Imperative/command form"},
  %{name: "volitional", display_name: "意向形 (よう)", word_type: "verb", suffix_pattern: "よう", description: "Volitional form (let's do)"},
  %{name: "conditional", display_name: "条件形 (れば)", word_type: "verb", suffix_pattern: "れば", description: "Conditional form (if)"},
]

# Adjective forms (い-adjectives)
ai_adjective_forms = [
  %{name: "dictionary", display_name: "辞書形 (い)", word_type: "adjective", suffix_pattern: "い", description: "Dictionary form"},
...
na_adjective_forms = [
  %{name: "dictionary", display_name: "辞書形 (だ)", word_type: "adjective", suffix_pattern: "だ", description: "Dictionary form with da"},
