...
ai_adjective_forms = [
  ...
  %{
    ...
    word_type: "adjective",
    suffix_pattern: "く",
    description: "Ku-form for adverbs"
  },
  %{
    name: "kute-form",
    display_name: "くて",
    word_type: "adjective",
    suffix_pattern: "くて",
    description: "Te-form for connecting"
  },
  %{
    name: "katta-form",
    display_name: "かった",
...
na_adjective_forms = [
  ...
  %{
    ...
    word_type: "adjective",
    suffix_pattern: "ではない",
    description: "Negative plain"
  },
  %{
    name: "dewa-nakatta-form",
    display_name: "ではなかった",
    word_type: "adjective",
    suffix_pattern: "ではなかった",
    description: "Negative past"
  }
]
...
all_forms = verb_forms ++ ai_adjective_forms ++ na_adjective_forms ++ shared_adjective_forms
